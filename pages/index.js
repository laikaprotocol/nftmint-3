...
//
  ...
  async function callContractData(wallet) {
    ...
    const bananaPrice = await bananaContract.methods.tokenPrice().call() 
  ...
  async function mintBanana(how_many_bananas) {
    if (bananaContract) {
      ...
      const gasAmount = await bananaContract.methods.mintToken(how_many_bananas).estimateGas({from: walletAddress, value: price})
      console.log("estimated gas",gasAmount)

      console.log({from: walletAddress, value: price})

      bananaContract.methods
            .mintToken(how_many_bananas)
  ...
  return (
    <div id="bodyy" className="flex flex-col items-center justify-center min-h-screen py-2">
      <Head>
        <title>RivrMaid Mint</title>
        <link rel="icon" href="/images/Hola.gif" />

        <meta property="og:title" content="RivrDoge RivrMaid Mint" key="ogtitle" />
        <meta property="og:description" content="RivrMaid Mint - RivrDoge" key="ogdesc" />
        <meta property="og:type" content="website" key="ogtype" />
        <meta property="og:url" content="https://rivrdogemint.com/" key="ogurl"/>
        <meta property="og:image" content="https://rivrdogemint.com/images/Hola.gif" key="ogimage"/>
        <meta property="og:site_name" content="https://rivrdogemint.com/" key="ogsitename" />

        <meta name="twitter:card" content="summary_large_image" key="twcard"/>
        <meta property="twitter:domain" content="rivrdogemint.com" key="twdomain" />
        <meta property="twitter:url" content="https://rivrdogemint.com/" key="twurl" />
        <meta name="twitter:title" content="RivrDoge - RivrMaid Mint" key="twtitle" />
        <meta name="twitter:description" content="RivrMaid Mint - RivrDoge." key="twdesc" />
        <meta name="twitter:image" content="https://rivrdogemint.com/images/Hola.gif" key="twimage" />
      </Head>
          ...
          <div className="mt-6 border-b-2 py-6">
            ...
            <div className="flex flex-col items-center">
                ...
                <div id="mint" className="flex justify-around  mt-8 mx-6">
                  ...
                  <span className="flex Poppitandfinchsans text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none px-3 font-bold">MAID!</span>
    
                </div>
                {saleStarted ? 
                <button onClick={() => mintBanana(how_many_bananas)} className="mt-4 Poppitandfinchsans text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">Mint {how_many_bananas} Maid for {(bananaPrice * how_many_bananas) / (10 ** 18)} MOVR + Gas</button>        
